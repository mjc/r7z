...
- Durable scope: current-codec read robustness for Copy, Deflate, Deflate64, BZip2, Delta, Swap2/Swap4, LZMA, LZMA2, BCJ+x86, AES-256-SHA-256 content, and AES encrypted headers. PPMd, AES writing, and symmetric write parity remain intentionally out of scope.
