...
- CLI method grammar: `-m0=METHOD:d=SIZE:fb=N:lc=N:lp=N:pb=N:mt=N`,
  `-md=SIZE`, `-mfb=N`, `-mlc=N`, `-mlp=N`, and `-mpb=N` for supported
  codecs; method-scoped `mt` is accepted as a no-op.
